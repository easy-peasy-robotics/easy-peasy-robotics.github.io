...
Importantly, the fourth day of the course we will make the leap _sim-to-real_ to challenge what you have learned in simulation and see how well your code will perform when controlling a real iCub head 🤖
